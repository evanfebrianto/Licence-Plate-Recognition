...
bool loadKNNDataAndTrainKNN(void) {
    ...
    //cv::FileStorage fsClassifications("classifications_asli.xml", cv::FileStorage::READ);        // open the classifications_asli file
    ...
    //cv::FileStorage fsTrainingImages("images_asli.xml", cv::FileStorage::READ);              // open the training images file
    ...
    kNearest->setDefaultK(5);                                                   // Default 1
